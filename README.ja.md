...
- [Source2ZE/CS2Fixes](https://github.com/Source2ZE/CS2Fixes) は、マップのエンティティ、trigger、サーバー側挙動によって一部マップで必要になる場合があります。
...
- [Source2ZE/CS2Fixes](https://github.com/Source2ZE/CS2Fixes): 一部マップで必要になる場合がある互換性向けプラグイン
